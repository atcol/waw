<template>
  ...
  >
    ...
    <v-card-text class="pt-0">
      <div class="title font-weight-light mb-2">{{ name }} ({{ id }})</div>
      <div class="subheading font-weight-light grey--text">Series Performance</div>
      ...
      <span class="caption grey--text font-weight-light">last registration </span>
    </v-card-text>
    <div :id="`chart_${id}`" />
  </v-card>
